...
public static partial class VentrixConfig
{
    ...
    private static void InitializeMischief(ConfigFile config)
    {
        ...
        MenaceCitizenNerveBase = config.Bind($"8. {NAME_SHORT_MENACE}", "Citizen Nerve (Base Level)", 0.3f,
        ...
        MenaceCitizenNerveFirst = config.Bind($"8. {NAME_SHORT_MENACE}", "Citizen Nerve (First Upgrade)", 0.2f,
        ...
        MenaceCitizenNerveSecond = config.Bind($"8. {NAME_SHORT_MENACE}", "Citizen Nerve (Second Upgrade)", 0.1f,
